...
public class StudentInfoFrame extends JFrame {
    ...
    public StudentInfoFrame(Student student) {
        ...
        editButton.setToolTipText("Click to edit student details");
        editButton.addActionListener(e -> editStudentInfo()); // Edit action
    ...
    // Method to handle "Edit" button action (this could be customized)
    private void editStudentInfo() {
        JOptionPane.showMessageDialog(this, "This feature is under development.", "Edit Info", JOptionPane.INFORMATION_MESSAGE);
    }
}
